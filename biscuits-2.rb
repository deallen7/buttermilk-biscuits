#Introduction
puts "Are you ready to bake some biscuits?? The only possible answer is 'yes' because who the heck wouldn't want biscuits?!?!"
sleep(2)
answer = gets.chomp
...
sleep(2)
puts "How many people are you baking biscuits for? Keep in mind I can't comprehend making biscuits for more than 25 people."
